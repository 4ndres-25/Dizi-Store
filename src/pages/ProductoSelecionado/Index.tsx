...
function ProductoSeleccionado({}: Props) {
  ...
  return (
    ...
    <div className={styles.productoSeleccionado}>
        ...
        <div className={styles.productoSeleccionado__Secciones}>

            <div className={styles.productoSeleccionado__GrupoImagenes}>
        ...
        <div className={styles.productoSeleccionado__MasInfo}>
