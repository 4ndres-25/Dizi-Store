...
function Menu({}: Props) {
  ...
  return (
    <div className={styles.menu__container}>
      ...
      <div className={`${showMenu ? styles["menu__containerFondo--on"] : "menu__containerFondo--off"}`}>
      </div>    
        <div className={`${styles["menu__main-container--off"]} ${showMenu ? styles["menu__main-container--on"] : ""}`} >
          ...
          <div >
            <h2 className={styles.menu__h2}>SÍGUENOS EN NUESTRAS REDES SOCIALES</h2>
            <div className={styles.menu__redesSociales}>
              <a className={`${styles.menu__redSocial} ${styles["menu__redSocial--facebook"]}`} href="https://www.facebook.com/share/17j4H6Ln84/" target="_blank">
              ...
              <a className={`${styles.menu__redSocial} ${styles["menu__redSocial--whatsapp"]}`} href="https://wa.me/59172234794" target="_blank">
              ...
              <a className={`${styles.menu__redSocial} ${styles["menu__redSocial--tiktok"]}`} href="https://www.tiktok.com/@dizistore.bol" target="_blank">
